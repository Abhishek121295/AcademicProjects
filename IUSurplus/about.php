         ...
         <div class="container">
            <div class="row d_flex">
               <div class="col-md-5">
                  <div class="titlepage">
                     <h2>About Us</h2>
                     <p>We manage the redistribution and disposal of unneeded university property for Indiana University. All proceeds go back into the university and help support students.</p>
